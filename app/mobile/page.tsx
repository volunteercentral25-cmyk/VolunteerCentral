...
export default function MobileHomePage() {
  ...
  return (
    <div className="min-h-screen gradient-bg overflow-hidden w-full">
      ...
      <main className="mx-auto max-w-7xl px-4 w-full">
        ...
        <section className="py-8 md:py-12">
          <div className="flex flex-col justify-center gap-6 text-center">
            <Badge className="w-fit mx-auto bg-gradient-to-r from-purple-600 to-pink-600 text-white">Join the movement</Badge>
            ...
            <div className="flex flex-col gap-3 max-w-sm mx-auto w-full">
              <Link href="#auth" className="btn-primary btn-hover-effect rounded-md px-5 py-3 text-center">Start now</Link>
              <Link href="/dashboard" className="btn-secondary rounded-md px-5 py-3 text-center">Go to dashboard</Link>
            </div>
            <div className="mt-4 grid grid-cols-3 gap-4 max-w-sm mx-auto">
              ...
              <div className="rounded-xl bg-white/70 p-3 text-center shadow-sm">
                <p className="text-2xl font-bold text-gradient">4K+</p>
        ...
        {/* Mobile Auth Card */}
        <section id="auth" className="py-8">
          <div className="flex justify-center">
            <Card className="glass-effect w-full max-w-sm border-0 shadow-xl">
              <CardHeader className="space-y-2 text-center">
                <div className="mx-auto mb-1 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-purple">
                  <User className="h-6 w-6 text-white" />
                </div>
                <CardTitle className="text-gradient text-xl">Welcome</CardTitle>
              ...
              >
                <Card className="group card-hover-effect border-0 bg-white/80">
                  <CardContent className="flex items-start gap-3 p-4">
                    <motion.div
                      className={`rounded-xl bg-gradient-to-br ${item.color} p-2 drop-shadow-md`}
                      animate={{ y: [0, -4, 0] }}
                      transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
                      whileHover={{ rotate: 6, scale: 1.1 }}
                    >
                      <item.icon className="h-5 w-5 text-gradient" aria-hidden="true" />
                    </motion.div>
                    <div>
        ...
        <section className="py-8 md:py-12">
          <div className="mb-6 text-center">
            <h2 className="text-balance text-2xl font-bold text-gray-900 md:text-3xl">How it works</h2>
        ...
        <section className="py-12">
          <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-purple-600 via-fuchsia-600 to-pink-600 text-white shadow-2xl">
            ...
            <CardContent className="relative z-10 grid gap-6 p-6 md:p-8">
              <div className="space-y-3 text-center">
                <h3 className="text-2xl font-bold md:text-3xl">Ready to make a difference?</h3>
                <p className="text-white/90">Create your account or jump straight into your dashboard to get started.</p>
              </div>
              <div className="flex flex-col gap-3 md:flex-row md:justify-center">
                <Link href="#auth" className="rounded-md bg-white px-5 py-3 font-medium text-purple-700 shadow-md transition hover:shadow-lg text-center">Create account</Link>
                <Link href="/dashboard" className="rounded-md bg-white/10 px-5 py-3 font-medium text-white backdrop-blur-sm ring-1 ring-white/30 transition hover:bg-white/20 text-center">Go to dashboard</Link>
              </div>
            </CardContent>
          </Card>
        </section>
      ...
      <footer className="mt-6 border-t border-white/40 bg-white/60 py-6 backdrop-blur-md w-full">
