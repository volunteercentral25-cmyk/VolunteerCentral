...
export default function MobileStudentHours() {
  ...
  return (
    <div className="min-h-screen gradient-bg overflow-hidden">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
          ...
          <Card className="glass-effect border-0 shadow-xl border-blue-200 bg-blue-50">
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-base font-semibold text-blue-900 mb-2">Email Verification Required</h3>
        ...
        >
          <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">Your Hours History</h2>
          {hoursData ? (
                    ...
                    <Card className="glass-effect border-0 shadow-lg">
                      <CardContent className="p-4">
                        <div className="space-y-3">
                          ...
                          <div>
                            <h3 className="text-base font-semibold text-gray-900">{hour.activity}</h3>
                          ...
                          <div className="space-y-2 text-sm text-gray-500">
                            ...
                            {hour.verification_email && (
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs">Verified by: {hour.verification_email}</span>
                              </div>
                            )}
                          </div>
