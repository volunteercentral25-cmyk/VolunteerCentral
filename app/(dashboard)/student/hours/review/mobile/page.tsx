...
export default function MobileStudentHoursReview() {
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/" className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Hours Review</p>
                </div>
              </Link>
            </div>
            <Button
      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        ...
        >
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
            Hours <span className="text-gradient">Review</span>
          </h1>
          <p className="text-base text-gray-600 max-w-xl mx-auto">
            Review and manage your volunteer hours. Track verification status and take action on pending submissions.
          </p>
        </motion.div>
